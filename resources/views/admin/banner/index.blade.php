                        ...
                        <tbody>
                            @foreach($banner as $key => $banner)
                                <tr>
                                    ...
                                    <td>{{ $banner->genre->name }}</td>
                                    <td>{{ $banner->title }}</td>
                                    <td>
                                        @php 
                                            $desc = strip_tags($banner['description']);
                                            $length = strlen($desc);
                                            if($length>50)
                                            {
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group" aria-label="Second group">
                                        <a href="{{ route('admin.banner.edit', $banner['id']) }}" class="btn btn-sm btn-primary edit-btn"><i class="fa fa-edit"></i></a>

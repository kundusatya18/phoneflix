...
@section('content')
        ...
        <div class="app-title">
            <div class="active-wrap">
                ...
                <div class="form-group">
                    ...
                    <a class="btn btn-secondary" href="{{ route('admin.genres.index') }}"><i style="vertical-align: baseline;" class="fa fa-chevron-left"></i>Back</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row section-mg row-md-body no-nav">
        <div class="col-md-12 mx-auto">
            <div class="tile">
                <form action="{{ route('admin.genres.store') }}" method="POST" role="form" enctype="multipart/form-data" id="form1">
                    @csrf

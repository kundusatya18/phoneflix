                ...
                <form action="{{ route('admin.users.store') }}" method="POST" role="form" enctype="multipart/form-data">
                    ...
                    <div class="tile-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control @error('country') is-invalid @enderror" type="country" name="country" id="country" value="{{ old('country') }}"/>
                            @error('country') {{ $message ?? '' }} @enderror
                        </div>
                        <div class="form-group">
                            <label class="control-label" for="name"> City <span class="m-l-5 text-danger"> *</span></label>
                            <input class="form-control @error('city') is-invalid @enderror" type="city" name="city" id="city" value="{{ old('city') }}"/>

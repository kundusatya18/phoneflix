  ...
  <body>
    <div class="login_wrap">
      <div class="login_left">
        <div class="login_box">
          <a href="{!! URL::to('') !!}"><img src="{!!asset('frontend/images/logo.png')!!}" class="login_logo"></a>
          <h2>Sign In With OTP</h2>
          <form id="loginForm" method="post" action="{!! URL::to('mobile-no-submit') !!}">
            @csrf
            <div class="form-group">
              <label class="control-label">Enter 10 digit mobile no</label>
              <input type="text" name="mobile" placeholder="Enter 10 digit mobile no" class="form-control" required="required">
            </div>
            ...
            <div class="form-group mb-0">
              <input type="submit" name="" value="Sign In" class="loginbtn">
            </div>
          </form>

    ...
    <div class="login_wrap">
      <div class="login_left">
        <div class="login_box">
          ...
          @endif
          <form id="loginForm" method="post" action="{!! URL::to('submit-otp') !!}">
            @csrf
            <input type="hidden" name="id" value="{{$id}}">
            <div class="form-group">
              <label class="control-label">Enter OTP</label>
              <input type="text" name="otp" placeholder="Enter OTP" class="form-control" required="required">
            </div>
            ...
            <div class="form-group mb-0">
              <input type="submit" name="" value="Submit" class="loginbtn">
            </div>
          </form>

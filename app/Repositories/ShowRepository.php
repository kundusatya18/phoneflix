...
class ShowRepository extends BaseRepository implements ShowContract
{
    ...
    public function createShow(array $params)
    {
        try {
            ...
            $Show->ppc_price = $collection['ppc_price'];
            $Show->ppc_offeredprice = $collection['ppc_offeredprice'];
            
            $Show->metakey = $collection['metakey'];
            $Show->metadescription = $collection['metadescription'];

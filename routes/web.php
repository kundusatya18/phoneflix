...
Route::get('profile/','Site\AuthController@profile')->name('site.profile');
Route::post('profile-update','Site\AuthController@updateprofile')->name('site.profileupdate');
Route::get('ppc-subscription/','Site\AuthController@subscription')->name('site.subscription');
Route::get('all-subscription/','Site\AuthController@allsubscription')->name('site.allsubscription');
